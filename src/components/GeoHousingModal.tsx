...
export const GeoHousingModal: React.FC<GeoHousingModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 bg-black/85 backdrop-blur-md animate-fadeIn font-['Plus_Jakarta_Sans']">
      <div className="w-full max-w-5xl max-h-[92vh] rounded-2xl border-2 border-cyan-500/80 bg-[#061224] shadow-[0_0_50px_rgba(6,182,212,0.35)] flex flex-col overflow-hidden text-slate-100">
        {/* Top Header */}
        <div className="flex items-center justify-between px-6 py-4 bg-[#030917] border-b border-cyan-900/60">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-cyan-950 border border-cyan-500 flex items-center justify-center text-cyan-400 font-bold shadow-[0_0_15px_rgba(6,182,212,0.4)]">
              <Compass size={20} />
            </div>
            <div>
              <div className="flex items-center gap-2">
                <h3 className="font-['Chakra_Petch'] font-bold text-base sm:text-lg text-white">
                  GEOMAKAZI // GEOGRAPHICAL AI HOUSING PLATFORM
                </h3>
                <span className="text-[10px] font-mono px-2 py-0.5 rounded bg-cyan-950 text-cyan-300 border border-cyan-500/60 font-bold">
                  ACTIVE ONGOING PROJECT
                </span>
              </div>
              <p className="text-xs font-mono text-slate-400">
                Solving Campus Comrades & National Housing Shortages Across Kenya (1.36T KES Housing Sector)
              </p>
            </div>
          </div>
        ...
        {/* Navigation Tabs */}
        <div className="flex border-b border-cyan-950 bg-[#040b18] px-6 text-xs font-['Chakra_Petch'] font-bold">
          <button
            onClick={() => {
              soundManager.playClick();
          ...
          >
            <Search size={14} />
            <span>COMRADE AI FINDER & SATELLITE ENGINE</span>
          </button>
          ...
          >
            <AlertCircle size={14} />
            <span>PROBLEM & SOCIOECONOMIC TELEMETRY</span>
          </button>
        </div>
